...
interface VentasMobileListProps {
  ...
  renderHeaderAside?: (record: VentaResumenDto) => ReactNode
  renderExtra?: (record: VentaResumenDto) => ReactNode
  ...
  return (
    <div className={styles.mobileCard}>
      <div className={styles.mobileCardTop}>
        ...
        {renderHeaderAside ? <div className={styles.mobileCardHeaderAside}>{renderHeaderAside(record)}</div> : null}
      </div>

      {renderExtra ? <div className={styles.mobileCardExtra}>{renderExtra(record)}</div> : null}

      <button type="button" className={styles.mobileCardToggle} onClick={handleToggle}>
        {expanded ? (
          <>
...
export function VentasMobileList({
  items,
  loading,
  ventaDetalleById,
  detalleLoadingById,
  ...
  renderHeaderAside,
  renderExtra,
  emptyDescription = 'Sin registros',
}: VentasMobileListProps) {
  if (loading) {
    return (
    ...
    <div className={styles.mobileCardList}>
      {items.map((record) => (
        <MobileCard
          ...
          renderHeaderAside={renderHeaderAside}
